...
- #### 手機上排版和顯示不會出錯（Tested on IPhone XS Safari & Samsung J4 Samaung Browser）
...
# 個人其他作品簡介
> ### 請注意：以下作品皆使用個人伺服器，但我沒錢，只能用個人電腦架在元智宿舍。原則上電腦都會開著，萬一真的遇到連不上的狀況，可能是伺服器暫時關閉，或是你使用校外之網路未開VPN。請稍後再試試看，或是打開VPN重試。
### 一、「共同特色」
- #### 大量使用MySQL、PHP、Ajax
